...
namespace MathSite.Migrations
{
    ...
    [Migration("20180711155016_AddMessagingSystem")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MathSite.Entities.Conversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("MathSite.Entities.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("MathSite.Entities.MessageUserConversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("MessageUserConversation");
                });
            ...
            modelBuilder.Entity("MathSite.Entities.UserConversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("MathSite.Entities.Conversation", b =>
                {
                    b.HasOne("MathSite.Entities.User", "Creator")
            ...
            modelBuilder.Entity("MathSite.Entities.Message", b =>
                {
                    ...
                    b.HasOne("MathSite.Entities.Conversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("MathSite.Entities.MessageUserConversation", b =>
                {
                    b.HasOne("MathSite.Entities.Message", "Message")
                        .WithMany("MessageUserConversations")
                        .HasForeignKey("MessageId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("MathSite.Entities.UserConversation", "UserConversation")
                        .WithMany("MessageUserConversations")

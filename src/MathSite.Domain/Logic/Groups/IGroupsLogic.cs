...
namespace MathSite.Domain.Logic.Groups
{
    public interface IGroupsLogic
    {
        ...
        Task<Guid> CreateAsync(string name, string description, string alias, string groupTypeAlias, bool isAdmin,
            Guid? parentGroupId);
        ...
        /// <param name="groupTypeAlias">Alias типа группы.</param>
        /// <param name="parentGroupId">Идентификатор родительской группы.</param>
        Task UpdateAsync(Guid groupId, string name, string description, string groupTypeAlias, bool isAdmin,
            Guid? parentGroupId);

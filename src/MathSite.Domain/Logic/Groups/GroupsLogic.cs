...
namespace MathSite.Domain.Logic.Groups
{
    public class GroupsLogic : LogicBase<Group>, IGroupsLogic
    {
        ...
        public async Task<Guid> CreateAsync(string name, string description, string alias, string groupTypeAlias,
            bool isAdmin, Guid? parentGroupId)
        {
        ...
        public async Task UpdateAsync(Guid groupId, string name, string description, string groupTypeAlias,
            bool isAdmin, Guid? parentGroupId)
        {
        ...
        public async Task<Group> TryGetGroupWithUsersWithRightsByIdAsync(Guid id)
        {
            return await TryGetGroup(
                groups => groups
                    .Include(group => group.Users).ThenInclude(user => user.UserRights)
